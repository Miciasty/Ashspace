window.WIKI_CONFIG = {
  ...
  product: 'Ashspace',
  version: '2.0.0',
  description: 'Ashspace 2.0.0: coordinate frames, rigid transforms, geometry conversion, and world-to-grid mapping for Java and Minecraft plugins.',
  ...
  links: {
    ...
    download: 'https://central.sonatype.com/artifact/dev.nasaka.blackframe/ashspace/2.0.0'
  }
};
